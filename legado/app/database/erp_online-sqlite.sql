...
FOREIGN KEY(seguimento_id) REFERENCES segmento(id),
FOREIGN KEY(condicao_pagamento_id) REFERENCES condicao_pagamento(id),
FOREIGN KEY(tabela_preco_id) REFERENCES tabela_preco(id),
FOREIGN KEY(motivo_bloqueio_id) REFERENCES motivo_bloqueio(id),
FOREIGN KEY(regiao_cliente_id) REFERENCES regiao_cliente(id),
FOREIGN KEY(situacao_cadastral_id) REFERENCES situacao_cadastral(id)) ; 
...
FOREIGN KEY(cliente_id) REFERENCES cliente(id),
FOREIGN KEY(situacao_cadastral_id) REFERENCES situacao_cadastral(id),
FOREIGN KEY(atividade_principal_id) REFERENCES cnae(id),
...
FOREIGN KEY(titulo_receber_id) REFERENCES titulo_receber(id)) ; 
...
FOREIGN KEY(cliente_id) REFERENCES cliente(id),
FOREIGN KEY(vendedor1_id) REFERENCES vendedor(id)) ; 
...
CREATE TABLE nota_entrada_item( 
      ...
      comodato char  (1)   , 
 PRIMARY KEY (id),
FOREIGN KEY(nota_entrada_id) REFERENCES nota_entrada(id)) ; 
...
CREATE TABLE nota_saida( 
 ...
 PRIMARY KEY (id),
FOREIGN KEY(vendedor1_id) REFERENCES vendedor(id),
FOREIGN KEY(vendedor2_id) REFERENCES vendedor(id),
FOREIGN KEY(filial_id) REFERENCES filial(id),
FOREIGN KEY(cliente_id) REFERENCES cliente(id),
FOREIGN KEY(fornecedor_id) REFERENCES fornecedor(id)) ; 
...
FOREIGN KEY(produto_id) REFERENCES produto(id),
FOREIGN KEY(tes_id) REFERENCES tipo_entrada_saida(id),
FOREIGN KEY(cliente_id) REFERENCES cliente(id),
FOREIGN KEY(vendedor1_id) REFERENCES vendedor(id),
FOREIGN KEY(vendedor2_id) REFERENCES vendedor(id)) ; 
...
FOREIGN KEY(estado_id) REFERENCES estado(id),
FOREIGN KEY(condicao_pagamento_id) REFERENCES condicao_pagamento(id),
FOREIGN KEY(orcamento_estado_id) REFERENCES orcamento_estado(id),
FOREIGN KEY(municipio_id) REFERENCES municipio(id),
FOREIGN KEY(vendedor_id) REFERENCES vendedor(id)) ; 
...
FOREIGN KEY(orcamento_id) REFERENCES orcamento(id),
FOREIGN KEY(orcamento_estado_id) REFERENCES orcamento_estado(id),
FOREIGN KEY(orcamento_proximo_estado_id) REFERENCES orcamento_estado(id)) ; 
...
CREATE TABLE orcamento_proximo_estado( 
 ...
 PRIMARY KEY (id),
FOREIGN KEY(orcamento_estado_id) REFERENCES orcamento_estado(id),
FOREIGN KEY(proximo_estado_id) REFERENCES orcamento_estado(id)) ; 
...
CREATE TABLE pedido( 
 ...
 PRIMARY KEY (id),
FOREIGN KEY(cliente_id) REFERENCES cliente(id),
FOREIGN KEY(pedido_estado_id) REFERENCES pedido_estado(id),
FOREIGN KEY(condicao_pagamento_id) REFERENCES condicao_pagamento(id),
FOREIGN KEY(transportadora_id) REFERENCES transportadora(id),
FOREIGN KEY(cliente_entrega_id) REFERENCES cliente(id),
FOREIGN KEY(vendedor1_id) REFERENCES vendedor(id),
FOREIGN KEY(vendedor2_id) REFERENCES vendedor(id),
FOREIGN KEY(orcamento_id) REFERENCES orcamento(id),
FOREIGN KEY(nota_saida_id) REFERENCES nota_saida(id)) ; 
...
FOREIGN KEY(te_id) REFERENCES tipo_entrada_saida(id),
FOREIGN KEY(ts_id) REFERENCES tipo_entrada_saida(id)) ; 
...
FOREIGN KEY(filial_id) REFERENCES filial(id),
FOREIGN KEY(pedido_id) REFERENCES pedido(id),
FOREIGN KEY(nota_fiscal_id) REFERENCES nota_saida(id)) ; 
...
FOREIGN KEY(cliente_id) REFERENCES cliente(id)) ; 
 ...
 CREATE UNIQUE INDEX unique_idx_cliente_cod_erp ON cliente(cod_erp);
 CREATE UNIQUE INDEX unique_idx_parametro_filial_id ON parametro(filial_id);
 CREATE UNIQUE INDEX unique_idx_parametro_parametro ON parametro(parametro);
 CREATE UNIQUE INDEX unique_idx_produto_cod_erp ON produto(cod_erp);
