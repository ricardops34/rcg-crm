...
CREATE TABLE blog_comunicados( 
      ...
      link_externo nvarchar(max)   , 
      link_texto nvarchar(max)   , 
      status char  (1)   , 
      ordenacao int   , 
      data_validade date   , 
      dt_alteracao datetime2   , 
...
CREATE TABLE cliente_atualizacao( 
      ...
      dt_alteracao datetime2   , 
      dt_inclusao datetime2   , 
      data_situacao_especial datetime2   , 
      situacao_especial varchar  (10)   , 
      atualizado_em datetime2   , 
      data_situacao_cadastral datetime2   , 
      simples varchar  (10)   , 
      tipo varchar  (10)   , 
      pais_id int   , 
      mei varchar  (10)   , 
...
CREATE TABLE notasaida_xml( 
      id  INT IDENTITY    NOT NULL  , 
      nota_saida_id int   , 
      xml_sig nvarchar(max)   , 
      xml_tss nvarchar(max)   , 
      xml_cancelamento nvarchar(max)   , 
      nota_fiscal varchar  (9)   , 
      serie_fiscal varchar  (3)   , 
      chave varchar  (100)   , 
...
CREATE TABLE produto( 
      ...
      dt_ult_compra date   , 
      ult_preco float   , 
      informacoes_tecnicas nvarchar(max)   , 
      dados_tecnicos nvarchar(max)   , 
      system_unit_id int   , 
      dt_inclusao datetime2   , 
      dt_alteracao datetime2   , 
 PRIMARY KEY (id)) ; 
...
CREATE TABLE produto_caracteristica( 
      ...
      produto_id int   NOT NULL  , 
      des_caracteristica nvarchar(max)   , 
