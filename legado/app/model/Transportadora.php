...
class Transportadora extends TRecord
{
    ...
    public function get_pedido_pedido_estado_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('pedido_estado_id','{pedido_estado->id}');
    ...
    public function get_pedido_cliente_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->razao}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_cliente_entrega_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('cliente_entrega_id','{cliente_entrega->razao}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_vendedor1_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('vendedor1_id','{vendedor1->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_vendedor2_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('vendedor2_id','{vendedor2->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_transportadora_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('transportadora_id','{transportadora->id}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_condicao_pagamento_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('condicao_pagamento_id','{condicao_pagamento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_orcamento_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('orcamento_id','{orcamento->dt_faturamento}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_nota_saida_to_string()
    {
        ...
        $values = Pedido::where('transportadora_id', '=', $this->id)->getIndexedArray('nota_saida_id','{nota_saida->id}');
        return implode(', ', $values);
    }
