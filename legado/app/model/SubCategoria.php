...
class SubCategoria extends TRecord
{
    ...
    public function getProdutos()
    {
        ...
        $criteria->add(new TFilter('sub_categoria_id', '=', $this->id));
    ...
    public function get_produto_filial_to_string()
    {
        ...
        $values = Produto::where('sub_categoria_id', '=', $this->id)->getIndexedArray('filial_id','{filial->apelido}');
    ...
    public function get_produto_categoria_to_string()
    {
        ...
        $values = Produto::where('sub_categoria_id', '=', $this->id)->getIndexedArray('categoria_id','{categoria->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_sub_categoria_to_string()
    {
        ...
        $values = Produto::where('sub_categoria_id', '=', $this->id)->getIndexedArray('sub_categoria_id','{sub_categoria->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fabricante_to_string()
    {
        ...
        $values = Produto::where('sub_categoria_id', '=', $this->id)->getIndexedArray('fabricante_id','{fabricante->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_armazem_to_string()
    {
        ...
        $values = Produto::where('sub_categoria_id', '=', $this->id)->getIndexedArray('armazem_id','{armazem->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_te_to_string()
    {
        ...
        $values = Produto::where('sub_categoria_id', '=', $this->id)->getIndexedArray('te_id','{te->id}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_ts_to_string()
    {
        ...
        $values = Produto::where('sub_categoria_id', '=', $this->id)->getIndexedArray('ts_id','{ts->id}');
        return implode(', ', $values);
    }
