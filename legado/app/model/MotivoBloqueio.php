...
class MotivoBloqueio extends TRecord
{
    ...
    public function getClientes()
    {
        ...
        $criteria->add(new TFilter('motivo_bloqueio_id', '=', $this->id));
        return Cliente::getObjects( $criteria );
    }
    /**
     * Method getSituacaoCadastrals
     */
    public function getSituacaoCadastrals()
    {
        $criteria = new TCriteria;
        $criteria->add(new TFilter('motivo_bloqueio_id', '=', $this->id));
        return SituacaoCadastral::getObjects( $criteria );
    }
    ...
    public function get_cliente_filial_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('filial_id','{filial->apelido}');
    ...
    public function get_cliente_tipo_cliente_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('tipo_cliente_id','{tipo_cliente->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_municipio_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('municipio_id','{municipio->cod_erp}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_vendedor_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('vendedor_id','{vendedor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_condicao_pagamento_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('condicao_pagamento_id','{condicao_pagamento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_tabela_preco_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('tabela_preco_id','{tabela_preco->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_seguimento_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('seguimento_id','{seguimento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_motivo_bloqueio_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('motivo_bloqueio_id','{motivo_bloqueio->id}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_regiao_cliente_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('regiao_cliente_id','{regiao_cliente->id}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_situacao_cadastral_to_string()
    {
        ...
        $values = Cliente::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('situacao_cadastral_id','{situacao_cadastral->descricao}');
        return implode(', ', $values);
    }

    public function set_situacao_cadastral_motivo_bloqueio_to_string($situacao_cadastral_motivo_bloqueio_to_string)
    {
        if(is_array($situacao_cadastral_motivo_bloqueio_to_string))
        {
            $values = MotivoBloqueio::where('id', 'in', $situacao_cadastral_motivo_bloqueio_to_string)->getIndexedArray('id', 'id');
            $this->situacao_cadastral_motivo_bloqueio_to_string = implode(', ', $values);
        }
        else
        {
            $this->situacao_cadastral_motivo_bloqueio_to_string = $situacao_cadastral_motivo_bloqueio_to_string;
        }

        $this->vdata['situacao_cadastral_motivo_bloqueio_to_string'] = $this->situacao_cadastral_motivo_bloqueio_to_string;
    }

    public function get_situacao_cadastral_motivo_bloqueio_to_string()
    {
        if(!empty($this->situacao_cadastral_motivo_bloqueio_to_string))
        {
            return $this->situacao_cadastral_motivo_bloqueio_to_string;
        }
    
        $values = SituacaoCadastral::where('motivo_bloqueio_id', '=', $this->id)->getIndexedArray('motivo_bloqueio_id','{motivo_bloqueio->id}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(Cliente::where('motivo_bloqueio_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
    
        if(SituacaoCadastral::where('motivo_bloqueio_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
