...
class RegiaoCliente extends TRecord
{
    const TABLENAME  = 'regiao_cliente';
    const PRIMARYKEY = 'id';
    ...
    public function getClientes()
    {
        ...
        $criteria->add(new TFilter('regiao_cliente_id', '=', $this->id));
    ...
    public function get_cliente_filial_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('filial_id','{filial->apelido}');
    ...
    public function get_cliente_tipo_cliente_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('tipo_cliente_id','{tipo_cliente->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_municipio_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('municipio_id','{municipio->cod_erp}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_vendedor_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('vendedor_id','{vendedor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_condicao_pagamento_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('condicao_pagamento_id','{condicao_pagamento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_tabela_preco_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('tabela_preco_id','{tabela_preco->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_seguimento_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('seguimento_id','{seguimento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_motivo_bloqueio_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('motivo_bloqueio_id','{motivo_bloqueio->id}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_regiao_cliente_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('regiao_cliente_id','{regiao_cliente->id}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_situacao_cadastral_to_string()
    {
        ...
        $values = Cliente::where('regiao_cliente_id', '=', $this->id)->getIndexedArray('situacao_cadastral_id','{situacao_cadastral->descricao}');
        return implode(', ', $values);
    }
    ...
    public function onBeforeDelete()
    {
        ...
        if(Cliente::where('regiao_cliente_id', '=', $this->id)->first())
        {
