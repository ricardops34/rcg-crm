...
class TabelaPreco extends TRecord
{
    ...
    public function getOrcamentos()
    {
        ...
        $criteria->add(new TFilter('tabela_preco_id', '=', $this->id));
    ...
    public function get_orcamento_cliente_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->razao}');
    ...
    public function get_orcamento_tabela_preco_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('tabela_preco_id','{tabela_preco->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_orcamento_condicao_pagamento_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('condicao_pagamento_id','{condicao_pagamento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_orcamento_pedido_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('pedido_id','{pedido->id}');
        return implode(', ', $values);
    }
    ...
    public function get_orcamento_vendedor_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('vendedor_id','{vendedor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_orcamento_estado_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('estado_id','{estado->sigla}');
        return implode(', ', $values);
    }
    ...
    public function get_orcamento_municipio_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('municipio_id','{municipio->cod_erp}');
        return implode(', ', $values);
    }
    ...
    public function get_orcamento_orcamento_estado_to_string()
    {
        ...
        $values = Orcamento::where('tabela_preco_id', '=', $this->id)->getIndexedArray('orcamento_estado_id','{orcamento_estado->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_tabela_preco_item_tabela_preco_to_string()
    {
        ...
        $values = TabelaPrecoItem::where('tabela_preco_id', '=', $this->id)->getIndexedArray('tabela_preco_id','{tabela_preco->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_tabela_preco_item_produto_to_string()
    {
        ...
        $values = TabelaPrecoItem::where('tabela_preco_id', '=', $this->id)->getIndexedArray('produto_id','{produto->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_filial_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('filial_id','{filial->apelido}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_tipo_cliente_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('tipo_cliente_id','{tipo_cliente->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_municipio_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('municipio_id','{municipio->cod_erp}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_vendedor_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('vendedor_id','{vendedor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_condicao_pagamento_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('condicao_pagamento_id','{condicao_pagamento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_tabela_preco_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('tabela_preco_id','{tabela_preco->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_seguimento_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('seguimento_id','{seguimento->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_motivo_bloqueio_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('motivo_bloqueio_id','{motivo_bloqueio->id}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_regiao_cliente_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('regiao_cliente_id','{regiao_cliente->id}');
        return implode(', ', $values);
    }
    ...
    public function get_cliente_situacao_cadastral_to_string()
    {
        ...
        $values = Cliente::where('tabela_preco_id', '=', $this->id)->getIndexedArray('situacao_cadastral_id','{situacao_cadastral->descricao}');
        return implode(', ', $values);
    }
