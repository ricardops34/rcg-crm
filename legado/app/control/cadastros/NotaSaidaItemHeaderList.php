...
class NotaSaidaItemHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_NotaSaidaItem';
    ...
    public function __construct($param = null)
    {
        ...
        $produto_cod_erp->exitOnEnter();
        $produto_descricao->exitOnEnter();

        $produto_cod_erp->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        $produto_descricao->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        ...
        $column_produto_cod_erp = new TDataGridColumn('produto->cod_erp', "Codigo", 'left' , '20%');
        $column_produto_descricao = new TDataGridColumn('produto->descricao', "Produto", 'left' , '30%');
        $column_qtd_transformed = new TDataGridColumn('qtd', "Qtd", 'right' , '5%');
        $column_vlr_total_transformed = new TDataGridColumn('vlr_total', "Valor", 'right' , '10%');
        $column_vlr_desconto_transformed = new TDataGridColumn('vlr_desconto', "Desconto", 'right' , '10%');
        $column_vendedor1_nome = new TDataGridColumn('vendedor1->nome', "Vendedor", 'left' , '15%');
        ...
        $this->datagrid->addColumn($column_vendedor1_nome);
        ...
        $td_produto_cod_erp = TElement::tag('td', $produto_cod_erp);
        $tr->add($td_produto_cod_erp);
        $td_produto_descricao = TElement::tag('td', $produto_descricao);
        $tr->add($td_produto_descricao);
        ...
        $this->datagrid_form->addField($produto_cod_erp);
        $this->datagrid_form->addField($produto_descricao);
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['NotaSaidaItemHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['NotaSaidaItemHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['NotaSaidaItemHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['NotaSaidaItemHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
