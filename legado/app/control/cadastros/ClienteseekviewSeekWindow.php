...
class ClienteseekviewSeekWindow extends TWindow
{
    private $form; // form
    ...
    private static $activeRecord = 'Clienteseekview';
    private static $primaryKey = 'cod_erp';
    private static $formName = 'form_ClienteseekviewSeekWindow';
    ...
    public function __construct($param = null)
    {
        ...
        parent::setTitle("ClienteSeekWindow");
        ...
        $this->form->setFormTitle("ClienteSeekWindow");
        ...
        $vendedor_id = new TDBCombo('vendedor_id', 'erp_online', 'Vendedor', 'id', '{cod_erp} {nome_reduzido}','cod_erp desc' , $criteria_vendedor_id );
        ...
        $row1 = $this->form->addFields([new TLabel("Código:", null, '14px', null, '100%'),$cod_erp],[new TLabel("Razao:", null, '14px', null, '100%'),$razao],[new TLabel("Fantasia:", null, '14px', null, '100%'),$fantasia],[new TLabel("Cnpj cpf:", null, '14px', null, '100%'),$cnpj_cpf],[new TLabel("Vendedor:", null, '14px', null, '100%'),$vendedor_id]);
        ...
        $column_cod_erp = new TDataGridColumn('cod_erp', "Código", 'center' , '70px');
        ...
        $column_ultima_visita_transformed = new TDataGridColumn('ultima_visita', "Ultima visita", 'left');
        $column_tabela_preco = new TDataGridColumn('tabela_preco', "Tabela preco", 'left');

        $column_ultima_visita_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
        ...
        $this->datagrid->addColumn($column_ultima_visita_transformed);
        $this->datagrid->addColumn($column_tabela_preco);

        $action_onSelect = new TDataGridAction(array('ClienteseekviewSeekWindow', 'onSelect'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Clienteseekview
            $repository = new TRepository(self::$activeRecord);
