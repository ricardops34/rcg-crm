<?php
/**
 * ClienteAtendimentoCalendarForm Form
 * @author  <your name here>
 */
class ClienteAtendimentoCalendarFormView extends TPage
{
    private $fc;
    ...
    public function __construct($param = null)
    {
        ...
        $this->fc->setDayClickAction(new TAction(array('ClienteAtendimentoCalendarForm', 'onStartEdit')));
        $this->fc->setEventClickAction(new TAction(array('ClienteAtendimentoCalendarForm', 'onEdit')));
        $this->fc->setEventUpdateAction(new TAction(array('ClienteAtendimentoCalendarForm', 'onUpdateEvent')));
    ...
    public static function getEvents($param=NULL)
    {
        ...
        try
        {
            ...
            $events = ClienteAtendimento::getObjects($criteria);
