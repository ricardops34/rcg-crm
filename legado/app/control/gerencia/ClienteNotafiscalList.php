...
class ClienteNotafiscalList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $this->datagrid->setGroupColumn('ano', "{ano}");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Gerencia","ClienteNotafiscalList"]));
        }
        $container->add($panel);
    ...
    public function onReload($param = NULL)
    {
        ...
        $filterVar = TSession::getValue(__CLASS__.'load_filter_cliente_id');
            ...
            elseif($param['order'] != 'ano')
            {
                $param['order'] = "ano,{$param['order']}"; 
            }
