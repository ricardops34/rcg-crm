...
export class SyncMasterDataController {
  ...
  @Post('clientes')
  async syncClientes(@Body() dto: SyncBatchDto) { return this.syncService.syncClientes(dto.conteudo); }

  @Post('produtos')
  async syncProdutos(@Body() dto: SyncBatchDto) { return this.syncService.syncProdutos(dto.conteudo); }

  @Post('vendedores')
  async syncVendedores(@Body() dto: SyncBatchDto) { return this.syncService.syncVendedores(dto.conteudo); }

  @Post('tabelas-preco')
  async syncTabelasPreco(@Body() dto: SyncBatchDto) { return this.syncService.syncTabelasPreco(dto.conteudo); }
}
